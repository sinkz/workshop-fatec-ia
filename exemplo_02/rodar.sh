...
echo -e "${BLUE}║  Exemplo 02: Produtos Simples             ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════╝${NC}"
echo ""
...
start_service "backend" "Backend (Express)" "npm start" "$CYAN"

# Iniciar MCP Server (porta 3003)
start_service "mcp-server" "MCP Server" "npm run dev" "$CYAN"

# Iniciar Frontend (porta 3000)
start_service "frontend" "Frontend (http-server)" "npm start" "$CYAN"
